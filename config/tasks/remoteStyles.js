...
const sassPaths = project.sourceDirectory + '/' + project.remoteWidgetDirectory + '/' + project.stylesDirectory + '/main.scss'
const autoprefixerSettings = targets.autoprefixer
const cssFileName = project.cssMinFileName
const dest = project.distDirectory + '/' + project.remoteWidgetDirectory + '/' + project.stylesDirectory
